    ...
    <div class="container" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300" data-aos-once="false">
        <div class="row row-cols-1 row-cols-md-3 g-4 justify-content-center pt-4 pb-4">
            ...
            <div class="col">
                <div class="card h-100 visi-misi">
                    <div class="card-body">
                        <h3 class="card-title fw-bold text-center">Misi</h3>
                        <p class="card-text">
                        <ol>
                            <li>Memberikan pelayanan yang terbaik kepada konsumen</li>
                            <li>Menjadikan semangat kreatif dan inovatif menjadi modal dasar untuk selalu bisa
                                berkembang</li>
                            <li>Menghasilkan produk - produk yang inovatif yang sesuai dan bermanfaat bagi masyarakat
                            </li>
