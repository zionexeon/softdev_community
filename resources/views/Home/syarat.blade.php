    ...
    <div class="card border-0 pt-3">
        <div class="card-body">
            ...
            <article data-aos="fade-right" data-aos-duration="1000" data-aos-delay="150" data-aos-once="true">
                ...
                <ol class="fs-5">
                    <li>Jika pengerjaan tidak sesuai dengan apa yang diminta klien</li>
                    <li>Jika kami melanggar semua ketentuan dan perjanjian yang telah dibuat</li>
                </ol>
            </article>
            <article data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200" data-aos-once="true">
                <h2 class="fw-bold">Surat Izin</h2>
                <ol class="fs-5">
                    <li>Jika pengerjaan tidak sesuai dengan apa yang diminta klien</li>
                    <li>Jika kami melanggar semua ketentuan dan perjanjian yang telah dibuat</li>
                </ol>
